App = {
  ...
  register : async() => {
    await App.load();
    await App.crowd.registerPoor({from:App.account});
  },
  ...
  donate:async() => {
    ...
    var a = $("#amount").val();
    window.alert(a);
    await App.crowd.donate({from:App.account, value:parseInt(a)});
  ...
  getBalance: async()=>{
    await App.load();
    var a = await App.crowd.getBalance();
    window.alert(a);
    $("#balance").html(a.toString());
